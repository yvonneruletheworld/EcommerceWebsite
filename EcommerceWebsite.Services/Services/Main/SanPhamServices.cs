...
namespace EcommerceWebsite.Services.Services.Main
{
    public class SanPhamServices : ISanPhamServices
    {
        ...
        public async Task<List<SanPhamVM>> LaySanPhamTheoLoai(int take = 1, string loaiSanPham = null, string maSanPham = null, string maKH = null, string comboCode = null)
        {
            try
            {
        ...
        public async Task<List<SanPhamVM>> LaySanPhamTheoLoaiKhongHUi(int take = 1, string loaiSanPham = null, string maSanPham = null, string maKH = null)
        {
            try
            {
                var data = await (from sp in _context.SanPhams.OrderByDescending(s => s.NgayTao)
            ...
            public async Task<List<PhieuNhap>> LayPhieuNhapSanPham()
            {
                try
                {
                    var data = await _context.PhieuNhaps.OrderByDescending(hui => hui.NgayTao.Date)
                                                                    .ThenByDescending(hui => hui.NgayTao.TimeOfDay).ToListAsync();
                    return data;
